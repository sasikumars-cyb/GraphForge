...
describe("PullRequestDetailPage - Publish Review", () => {
  ...
  it("disables Publish Review until an AI analysis exists", async () => {
    ...
    const button = await screen.findByRole("button", { name: "Publish Review" });
  ...
  it("enables Publish Review once an AI analysis exists and publishes it", async () => {
    ...
    expect(await screen.findByRole("button", { name: "✓ Review published" })).toBeInTheDocument();
    const link = await screen.findByRole("link", { name: "View published comment on GitHub →" });
  ...
  it("disables Publish Review while another AI action is in flight", async () => {
    ...
    const publishButton = await screen.findByRole("button", { name: "Publish Review" });
