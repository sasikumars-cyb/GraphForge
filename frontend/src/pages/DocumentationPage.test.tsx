...
describe("DocumentationPage", () => {
  ...
  it("disables Run Analysis until a repository is selected", async () => {
    mockedListTrackedRepositories.mockResolvedValue([]);
    renderWithAuth();
    const button = screen.getByRole("button", { name: "Run documentation analysis" });
  ...
  it("enables Run Analysis once a repository is selected", async () => {
