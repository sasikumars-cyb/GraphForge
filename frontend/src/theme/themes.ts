...
export const THEMES: ThemeDefinition[] = [
  {
    ...
    mode: "light",
    swatch: { background: "#f8fafc", surface: "#f1f5f9", accent: "#8425ff", text: "#0f172a" },
  },
  {
    id: "dark",
    label: "Dark",
    ...
    mode: "dark",
    swatch: { background: "#020617", surface: "#0f172a", accent: "#8425ff", text: "#f1f5f9" },
  },
  {
    id: "midnight",
    label: "Midnight",
    ...
    mode: "dark",
    swatch: { background: "#02040f", surface: "#0a0e24", accent: "#9147ff", text: "#eef1fb" },
  },
  {
    id: "modern-blue",
    label: "Modern Blue",
    description: "Steel-blue neutrals with a vivid blue accent.",
    mode: "dark",
    swatch: { background: "#040a14", surface: "#0d1626", accent: "#1c86ff", text: "#e6edf9" },
  },
  {
    id: "high-contrast",
    label: "High Contrast",
    ...
    mode: "light",
    swatch: { background: "#ffffff", surface: "#f5f5f5", accent: "#7a00e6", text: "#000000" },
  },
];
